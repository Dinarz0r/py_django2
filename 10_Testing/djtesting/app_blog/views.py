...
from .models import ImagesModel, Blog
...
def add_new_blog_view(request):
    ...
    if request.method == "POST" and request.user.is_authenticated:
        ...
        if request.user.is_authenticated:
            ...
            return HttpResponse(_('У вас не достаточно прав'))
...
def add_mass_blog_using_csv(request):
    ...
    if request.method == "POST" and request.user.is_authenticated:
        ...
        if request.user.is_authenticated:
            ...
            return HttpResponse(_('У Вас не достаточно прав для добавления нового блога'))
